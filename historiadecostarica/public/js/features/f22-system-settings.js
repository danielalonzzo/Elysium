/** F22 · System Settings · Historia de Costa Rica. */
(function () {
  "use strict";

  function getDefaultTheme() {
    try {
      var crTime = new Date().toLocaleTimeString("en-US", { timeZone: "America/Costa_Rica", hour12: false, hour: "numeric", minute: "numeric" });
      var parts = crTime.split(":");
