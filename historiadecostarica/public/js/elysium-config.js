...
(function () {
  ...
  window.ELYSIUM_PRELOADER = {
    ...
    logoHTML: '<img src="/logo.jpg" alt="" width="92" height="92" style="border-radius:18px">',
  ...
  window.ELYSIUM_SYSTEM = {
    ...
    brandName: "HISTORIA DE COSTA RICA",
    brandSymbolHTML: '<img src="/logo.jpg" alt="Historia de Costa Rica" style="width:112px;border-radius:16px;margin-bottom:8px;">',
    accent: "#A75D39",
    theme: "dark",
