...
supportEmail: 'info@elysiumdr.eu',
techEmail: 'daniel.morales@elysiumdr.eu',
...
'.ely-row-label{flex-shrink:0;font-weight:600;}',
'.ely-row-value{color:' + P.dim + ';text-align:right;min-width:0;overflow-wrap:anywhere;',
' display:flex;align-items:center;gap:8px;justify-content:flex-end;}',
'.ely-link-val{color:' + cfg.accent + ';text-decoration:none;text-align:right;overflow-wrap:anywhere;}',
'.ely-link-val:hover{opacity:.75;}',
'.ely-stage-badge{',
...
return '<div class="ely-row"><span class="ely-row-label">' + label
+ '</span><span class="ely-row-value">' + valueHTML + '</span></div>';
}
function linkRow(label, href, text, external) {
var attrs = external ? ' target="_blank" rel="noopener noreferrer"' : '';
return '<div class="ely-row"><span class="ely-row-label">' + label
+ '</span><a class="ely-link-val" href="' + href + '"' + attrs + '>' + text + '</a></div>';
}
