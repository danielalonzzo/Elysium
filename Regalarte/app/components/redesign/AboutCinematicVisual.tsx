...
const LazyAboutExperience = dynamic(
  () => import("../experience/AboutCostaRicaExperience").then((module) => module.AboutCostaRicaExperience),
  { ssr: false },
);

export function AboutCinematicVisual({ progress }: { progress: number }) {
