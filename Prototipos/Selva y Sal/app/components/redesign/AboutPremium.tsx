...
const ABOUT_SCENES = [
  {
    ...
    description: "Dos guías que dejaron de trabajar para agencias ajenas y empezaron a llevar gente al Arenal por su cuenta. Eso fue en 2009.",
    start: 0,
    end: 0.45,
    align: "start",
  },
  {
    id: "recuerdo",
    index: "02",
    eyebrow: "Por qué seguimos",
    title: "Grupos pequeños, guías de aquí.",
    description: "Once rutas propias, veintidós guías y una tienda que diseña lo que vende en lugar de revender lo de siempre.",
    start: 0.55,
    end: 1,
    align: "end",
  },
        ...
        {ABOUT_SCENES.map((scene) => {
          ...
          return (
            ...
            >
              ...
              {scene.id === "costa" && <p className="rgx-scroll-cue"><span aria-hidden="true">↓</span> Desliza para conocer más</p>}
              {scene.id === "recuerdo" && (
...
export function AboutPremium({
  ...
  return (
    <section
      ...
      aria-label="Acerca de Selva y Sal"
