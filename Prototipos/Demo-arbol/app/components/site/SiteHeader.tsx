...
import { BRAND, CONTACT, NAV, WHATSAPP_LABEL, linkTo } from "../../data/content";
  ...
  return (
    <header id="header" className="navbar header-on-dark">
      <div className="nav-pill">
        ...
        <NavLink className="brand" href="#top" ariaLabel="Inicio">
        ...
        <nav className="nav-menu" id="navMenu" aria-label="Navegación principal">
          ...
          <div className="nav-drawer-foot">
            <a href={linkTo(CONTACT.whatsapp)} target="_blank" rel="noopener noreferrer">
              {WHATSAPP_LABEL}
            </a>
          </div>
        </nav>
