...
#
#   historiadecostarica/    → código fuente (Next 16, excluido del despliegue)
#   historia-de-costa-rica/ → sitio estático servido en elysiumdr.eu/historia-de-costa-rica/
#
# Uso:  ./scripts/publish-historiadecostarica.sh
#
set -euo pipefail

PREFIX="/historia-de-costa-rica"
ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
SRC="$ROOT/historiadecostarica"
...
OUT="$SRC/out"
[ -f "$OUT/index.html" ] || OUT="$SRC/.next-export"
